...
```sh
bash /tmp/linubot-install.sh --version 2.9.0 --launch
```
...
```sh
bash /tmp/linubot-install.sh --version 2.9.0 --build --launch
```
...
```sh
sudo apt install ./release/linubot-2.9.0-amd64.deb
```
