...
export function renderHome(ctx) {
  ...
  const paint = (data) => {
    ...
    ctx.root.querySelector("[data-connect]").innerHTML = data.provider.ready ? "" : `<div class="connect-line">${icon("tool")}<span>Connect a model to start chatting.</span><a href="#/settings/provider">Connect ${icon("arrow")}</a></div>`;
