...
export async function renderConversation(ctx) {
  ...
  root.querySelector("[data-rail-toggle]").onclick = () => { toggleRail(controls.rail.hidden); root.querySelector(".conversation-menu").open = false; };
