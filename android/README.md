...
See [phone setup and build instructions](../docs/PHONE.md). The app uses Internet permission and requests camera access for QR scanning. It rejects invalid TLS certificates and shares downloaded
